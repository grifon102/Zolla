...
namespace Zolla.Web.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Description,Status,ClientId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Description,Status,ClientId")] Order order)
        {
            if (ModelState.IsValid)
            {
